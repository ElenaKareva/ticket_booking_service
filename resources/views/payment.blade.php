  ...
  <main>
    <section class="ticket">
      ...
      <div class="ticket__info-wrapper">
        ...
        <button class="acceptin-button" onclick="location.href=`{{ route('ticket', [ 'film_title' => $film_title, 'hall_name' => $hall_name, 'session_start' => $session_start, 'session_date' => $session_date, 'places' => $places, 'priceSum' => $priceSum]) }}`">Получить код бронирования</button>
